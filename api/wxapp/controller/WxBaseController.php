...
class WxBaseController extends AuthController
{
    ...
    /**
     * 微信订单退款 测试
     *   test_environment: http://doctor2.ikun:9090/api/wxapp/wx_base/wx_refund_test
     *   official_environment: http://xcxkf203.aubye.com/api/wxapp/wx_base/wx_refund_test
     ...
     *
     *
     *   test_environment: http://doctor2.ikun:9090/api/wxapp/wx_base/send_temp_msg_test
     *   official_environment: http://xcxkf203.aubye.com/api/wxapp/wx_base/send_temp_msg_test
     ...
     * 发货测试用
     *
     *   test_environment: http://doctor2.ikun:9090/api/wxapp/wx_base/send_shipping
     *   official_environment: http://xcxkf203.aubye.com/api/wxapp/wx_base/send_shipping
    ...
    /**
     *  文字违规检测 测试
     *   test_environment: http://doctor2.ikun:9090/api/wxapp/wx_base/msg_sec_check_test
     *   official_environment: http://xcxkf203.aubye.com/api/wxapp/wx_base/msg_sec_check_test
    ...
    /**
     *  微信转账实例
     *  调用示例 http://xcxkf203.aubye.com/api/wxapp/wx_base/example
     */
    ...
    /**
     * 测试生成小程序(太阳)码
     * 调用示例  http://xcxkf203.aubye.com/api/wxapp/wx_base/get_mini_qr_test
     */
    ...
    /**
     * 测试生成小程序(方形)码
     * 调用示例  http://xcxkf203.aubye.com/api/wxapp/wx_base/get_mini_square_qr_test
     */
    ...
    /**
     * 微信转账回调 (官方回调)
     * 调用示例 http://xcxkf203.aubye.com/api/wxapp/wx_base/notify
     */
     ...
     * 调用示例 http://xcxkf203.aubye.com/api/wxapp/wx_base/update_official_openid
     */
     ...
     *
     *
     *   test_environment: http://doctor2.ikun:9090/api/wxapp/wx_base/find_official
     *   official_environment: http://xcxkf203.aubye.com/api/wxapp/wx_base/find_official
     ...
     * @return  string
     *
     *   test_environment: http://doctor2.ikun:9090/api/wxapp/wx_base/sendTempMsg
     *   official_environment: http://xcxkf203.aubye.com/api/wxapp/wx_base/sendTempMsg
     ...
     *
     *   test_environment: http://doctor2.ikun:9090/api/wxapp/wx_base/qrcode_create
     *   official_environment: http://xcxkf203.aubye.com/api/wxapp/wx_base/qrcode_create
     ...
     *
     *   test_environment: http://doctor2.ikun:9090/api/wxapp/wx_base/addWeixinMenu
     *   official_environment: http://xcxkf203.aubye.com/api/wxapp/wx_base/addWeixinMenu
     ...
     * @throws \WeChat\Exceptions\LocalCacheException
     *
     *   test_environment: http://doctor2.ikun:9090/api/wxapp/wx_base/batch_get_material
     *   official_environment: http://xcxkf203.aubye.com/api/wxapp/wx_base/batch_get_material
     ...
     *
     *   test_environment: http://doctor2.ikun:9090/api/wxapp/wx_base/get_stable_access_token
     *   official_environment: http://xcxkf203.aubye.com/api/wxapp/wx_base/get_stable_access_token
